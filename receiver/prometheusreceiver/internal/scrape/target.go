...
type Target struct {
	...
	scrapeConfig *scrapeconfig.ScrapeConfig
...
func NewTarget(labels labels.Labels, scrapeConfig *scrapeconfig.ScrapeConfig, tLabels, tgLabels model.LabelSet) *Target {
	return &Target{
		labels:       labels,
		tLabels:      tLabels,
		tgLabels:     tgLabels,
...
func (t *Target) SetScrapeConfig(scrapeConfig *scrapeconfig.ScrapeConfig, tLabels, tgLabels model.LabelSet) {
	t.mtx.Lock()
	defer t.mtx.Unlock()
...
func PopulateDiscoveredLabels(lb *labels.Builder, cfg *scrapeconfig.ScrapeConfig, tLabels, tgLabels model.LabelSet) {
...
func PopulateLabels(lb *labels.Builder, cfg *scrapeconfig.ScrapeConfig, tLabels, tgLabels model.LabelSet) (res labels.Labels, err error) {
	PopulateDiscoveredLabels(lb, cfg, tLabels, tgLabels)
...
func TargetsFromGroup(tg *targetgroup.Group, cfg *scrapeconfig.ScrapeConfig, targets []*Target, lb *labels.Builder) ([]*Target, []error) {
	targets = targets[:0]
	failures := []error{}
